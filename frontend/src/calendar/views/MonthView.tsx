...
export default function MonthView({ date, activities, onDayClick, onEventClick, onEventEdit, onEventDelete, gcalEnabled = false }: Props) {
          ...
          return (
            ...
            >
              ...
              <AnimatePresence mode="popLayout">
                {visible.map(act => (
                  <CalendarEvent key={act.id} activity={act} variant="month" onClick={onEventClick} onEdit={onEventEdit ?? onEventClick} onDelete={onEventDelete} gcalEnabled={gcalEnabled} />
                ))}
              </AnimatePresence>
              {overflow > 0 && (
