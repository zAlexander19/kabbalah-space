...
bad = r'return \(\s*<div\s*key=\{node\.id\}\s*className=\{bsolute rounded\-full flex flex\-col items\-center\s*justify\-center text\-center border border\-white/30\s*shadow-\[0_0_20px_rgba\(0,0,0,0\.35\)\] \$\{node\.colorClass\}\}\s*style=\{\{'
...
print(f'Replaced? {new_text != text}')
