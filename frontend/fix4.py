...
new_str = '''            {sefirot.map((node) => {
              ...
              return (
                <div
                  ...
                  className={bsolute rounded-full flex flex-col items-center justify-center text-center border border-white/30 shadow-[0_0_20px_rgba(0,0,0,0.35)]  cursor-pointer transition-all hover:scale-105  }'''

if old_str in text:
    print('Found by string')
